...
export const eventMedia: EventMedia = {
  ...
  workflow: {
    ...
    steps: [
      ...
      { title: 'Final Delivery',        body: 'Hero recap + first vertical social cuts delivered within 48 hours of show end. Tour packages and multi-day festival scopes run longer — quoted up front when the engagement is set.' },
