...
export const eventMedia: EventMedia = {
  ...
  hero: {
    ...
    sub:
      'Recap edits, multicam moments, vertical social cuts, photography, and 48-hour delivery, built for artists who want every show to become weeks of content, not a one-night spike. Larger scopes (tour cuts, multi-day festival packages) extend the timeline; everything is quoted up front.',
    pills: [
      '48-hour delivery',
      'Multicam coverage',
      'Festival + tour',
  ...
  whatWeCapture: {
    ...
    cards: [
      ...
      { title: 'Single shows',      body: 'One-night headline or feature slots. Multicam capture, photography, and 48-hour delivery so the moment doesn\'t fade before the next show.' },
    ],
  },
  ...
  workflow: {
    ...
    steps: [
      ...
      { title: 'Post-Show Triage',      body: 'Within 24 hours: rough cuts of the hero recap and top 3 vertical moments queued for review.' },
      { title: 'Final Delivery',        body: 'Hero recap + first vertical social cuts delivered within 48 hours of show end. Tour packages and multi-day festival scopes run longer, and we quote that timeline up front when the engagement is set.' },
      { title: 'Distribution Support',  body: 'Captions, hooks, posting recommendations included. We hand off ready-to-schedule files.' },
    ],
  },

  whoFor: {
    eyebrow: "Who It's For",
    headline: 'Built for artists treating every show <span class="highlight">like a campaign.</span>',
    cards: [
      ...
      { title: 'Festival circuits.',                  body: "You're slotting Dancefestopia, Electric Forest, Lost Lands. Every weekend a new festival. We turn the circuit into a content stream." },
